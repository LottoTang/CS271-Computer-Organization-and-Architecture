...
; (insert executable instructions here)
    ...
    PUSH    OFFSET  intro1                                  ; push the offset of strings as assignment requirement
    PUSH    OFFSET  intro2
    PUSH    OFFSET  intro3
    PUSH    OFFSET  intro4
    PUSH    OFFSET  intro5
...
;============================================
    ...
    _nextNumber:                                            ; special case: once 0 is found, the remaining array should also be 0, just let the loop continues till ECX = 0
    ADD     ESI,  4
    LOOP    _displayArray      
